...
class Imagedb_ImagegroupController extends Zend_Controller_Action
{
    ...
    {
    	$model = new Default_Model_ImageGroup();
    ...
    public function formAction(){
    	$request = $this->getRequest();
		$form = new Default_Form_ImageGroup();
		
		if ($request->isPost()){
			if ($form->isValid($request->getPost())){
				$model = new Default_Model_ImageGroup($form->getValues());
				$model->save();
